...
export class JogoDaVelhaService {
  ...
  /**
   * Inicializa o jogo. Define exibição inicial
   *
   * @return void
   */
  inicializar(): void {
  ...
  /**
   * Retorna o id do jogador a jogar
   *
   * @readonly
   * @type {number}
   * @memberof JogoDaVelhaService
  ...
  exibirX(posX: number, posY: number): boolean {
    return this.tabuleiro[posY][posY] === this.X;
  }
  exibirO(posX: number, posY: number): boolean {
    return this.tabuleiro[posY][posY] === this.O;
  }
